...
```{r raw, echo=FALSE,fig.cap='raw data set of No. of children in 54 families',fig.height=4, fig.align='center'}
...
```{r freq, echo=FALSE,fig.cap='Frequency distribution table',fig.height=4, fig.align='center'}
...
```{r mass, echo=FALSE,fig.cap='Body masses of 22 patients',fig.height=4, fig.align='center'}
...
```{r grptable, echo=FALSE,fig.cap='Grouped Frequency distribution table',fig.height=4, fig.align='center'}
